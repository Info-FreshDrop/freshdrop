        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              ...
              <h1 className="text-3xl font-bold text-primary">FreshDrop</h1>
            </div>
            <h2 className="text-4xl font-bold text-foreground mb-4">Laundry made easy</h2>
          ...
          <Card className="shadow-glow bg-white/95 backdrop-blur-sm border-0 rounded-2xl overflow-hidden">
            {showOperatorLogin ? (
