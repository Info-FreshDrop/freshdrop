...
-- First check and fix any invalid data before adding constraints
...
-- 4. Limit special instructions length to prevent abuse
ALTER TABLE public.orders 
ADD CONSTRAINT reasonable_instructions_length 
CHECK (char_length(special_instructions) <= 500);

-- 5. Enhanced promo code validation function
