...
INSERT INTO public.security_events (
  ...
  'security_fix',
  'Fixed operator_applications table RLS policies to prevent PII exposure',
  jsonb_build_object(
    'table', 'operator_applications',
    'issue', 'Sensitive personal data accessible to all authenticated users',
    'fix', 'Restricted access to application owners and admins only'
  )
);